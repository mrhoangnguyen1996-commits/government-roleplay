...
server.listen(PORT, () => {
    console.log(`[REALTIME CENTRAL V8.0] RUNNING PERFECTLY ON PORT ${PORT}`);
    console.log(`[VÁ LỖI NGHIÊM TRỌNG] Đồng bộ trạng thái dự phòng qua HTTP (/api/state) đã kích hoạt — nút thẩm định/xử lý hồ sơ luôn phản hồi ngay cả khi WebSocket chập chờn.`);
