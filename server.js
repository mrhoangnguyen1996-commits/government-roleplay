...
let systemState = {
    ...
    authorizedPersonnel: {
        ...
        // Demo đủ đơn vị — mật khẩu 123 — phục vụ nhập vai đa ban ngành
        "canbo_qd": { username: "canbo_qd", password: "123", displayName: "Thượng Úy Phạm Quốc Bảo", role: "CHUYÊN VIÊN", agency: "QUÂN ĐỘI", positiveRatings: 3, negativeRatings: 0 },
        "lanhdao_qd": { username: "lanhdao_qd", password: "123", displayName: "Đại Tá Hoàng Văn Sơn", role: "LÃNH ĐẠO", agency: "QUÂN ĐỘI", positiveRatings: 5, negativeRatings: 0 },
        "canbo_ta": { username: "canbo_ta", password: "123", displayName: "Thẩm Phán Viên Lê Thu Hà", role: "CHUYÊN VIÊN", agency: "TOÀ ÁN", positiveRatings: 4, negativeRatings: 0 },
        "lanhdao_ta": { username: "lanhdao_ta", password: "123", displayName: "Chánh Án Nguyễn Đức Minh", role: "LÃNH ĐẠO", agency: "TOÀ ÁN", positiveRatings: 6, negativeRatings: 0 },
        "canbo_yt": { username: "canbo_yt", password: "123", displayName: "BS. Trần Mai Anh", role: "CHUYÊN VIÊN", agency: "Y TẾ", positiveRatings: 4, negativeRatings: 0 },
        "lanhdao_yt": { username: "lanhdao_yt", password: "123", displayName: "BSCKII. Phạm Hữu Tài", role: "LÃNH ĐẠO", agency: "Y TẾ", positiveRatings: 5, negativeRatings: 0 },
        "canbo_gd": { username: "canbo_gd", password: "123", displayName: "Giáo Viên Nguyễn Thị Lan", role: "CHUYÊN VIÊN", agency: "GIÁO DỤC", positiveRatings: 3, negativeRatings: 0 },
        "lanhdao_gd": { username: "lanhdao_gd", password: "123", displayName: "Hiệu Trưởng Đỗ Quang Huy", role: "LÃNH ĐẠO", agency: "GIÁO DỤC", positiveRatings: 5, negativeRatings: 0 },
        "canbo_tc": { username: "canbo_tc", password: "123", displayName: "Kiểm Soát Viên Vũ Thanh Tùng", role: "CHUYÊN VIÊN", agency: "TÀI CHÍNH", positiveRatings: 3, negativeRatings: 0 },
        "lanhdao_tc": { username: "lanhdao_tc", password: "123", displayName: "Cục Trưởng Lê Hoàng Nam", role: "LÃNH ĐẠO", agency: "TÀI CHÍNH", positiveRatings: 5, negativeRatings: 0 },
        "canbo_ub": { username: "canbo_ub", password: "123", displayName: "Chuyên Viên Hộ Tịch Mai Phương", role: "CHUYÊN VIÊN", agency: "UBND", positiveRatings: 3, negativeRatings: 0 },
        "lanhdao_ub": { username: "lanhdao_ub", password: "123", displayName: "Chủ Tịch UBND Trần Quốc Việt", role: "LÃNH ĐẠO", agency: "UBND", positiveRatings: 6, negativeRatings: 0 },
        "canbo_cp": { username: "canbo_cp", password: "123", displayName: "Chuyên Viên VPCP Hoàng Anh", role: "CHUYÊN VIÊN", agency: "CHÍNH PHỦ", positiveRatings: 4, negativeRatings: 0 },
        "lanhdao_cp": { username: "lanhdao_cp", password: "123", displayName: "Thứ Trưởng Điều Phối Nguyễn Khánh", role: "LÃNH ĐẠO", agency: "CHÍNH PHỦ", positiveRatings: 7, negativeRatings: 0 }
    },
    archiveReturnRequests: []
};

/** Nhiệm vụ ca theo đơn vị — cán bộ nhận / hoàn thành trong ca trực */
let unitMissions = []; // { id, agency, code, title, hint, status, assignedTo, assignedName, claimedBy, completedBy, date, createdAt }
...
app.post('/api/resident/violation', requireAuth(), safeRoute(async (req, res) => {
    ...
    criminalRecordsRegistry[username].unshift({
        id: recordId, type, lawClause, fine, status,
        officer: req.officer.displayName, agency: req.officer.agency,
        date: new Date().toLocaleDateString('vi-VN')
    });
    bumpShiftStat(req.officer.username, 'appsProcessed', 1);
    addLog(`Cán bộ [${req.officer.displayName}] [${req.officer.agency}] lập biên bản [${recordId}] — ${type} cho @${username}.`);
    broadcastUpdate();
    res.json({ success: true });
}));

// ---- NHIỆM VỤ CA THEO ĐƠN VỊ (nhập vai) ----
const AGENCY_MISSION_TEMPLATES = {
    'CÔNG AN': [
        { code: 'CA-PATROL', title: 'Tuần tra địa bàn', hint: 'Ghi nhật ký tuần tra / xử lý ANTT' },
        { code: 'CA-ID', title: 'Thụ lý hồ sơ định danh', hint: 'Tiếp nhận hoặc trình ký hồ sơ CCCD/hộ khẩu' },
        { code: 'CA-FINE', title: 'Lập biên bản xử phạt', hint: 'Lập biên bản giao thông / ANTT' }
    ],
    'QUÂN ĐỘI': [
        { code: 'QD-ROSTER', title: 'Điểm danh quân số', hint: 'Hoàn tất điểm danh ca trực' },
        { code: 'QD-ARM', title: 'Kiểm soát vũ khí', hint: 'Cấp / kiểm giấy phép vũ khí' },
        { code: 'QD-SOS', title: 'Ứng phó an ninh quân sự', hint: 'Tiếp nhận SOS quân sự hoặc ghi nhật ký' }
    ],
    'TOÀ ÁN': [
        { code: 'TA-DOCKET', title: 'Thụ lý án thư', hint: 'Tiếp nhận đơn khởi kiện / tố cáo' },
        { code: 'TA-SUMMON', title: 'Cấp giấy triệu tập', hint: 'Cấp phôi triệu tập' },
        { code: 'TA-MINUTE', title: 'Ghi biên bản phiên', hint: 'Nộp nhật ký biên bản phiên' }
    ],
    'THANH TRA': [
        { code: 'TT-COMPLAINT', title: 'Thụ lý tố cáo', hint: 'Xử lý hồ sơ tố cáo / khiếu nại' },
        { code: 'TT-AUDIT', title: 'Kiểm tra liên ngành', hint: 'Lập kiến nghị thanh tra' },
        { code: 'TT-REPORT', title: 'Báo cáo kết luận', hint: 'Nộp báo cáo thanh tra' }
    ],
    'CHÍNH PHỦ': [
        { code: 'CP-DECREE', title: 'Ban hành sắc lệnh', hint: 'Công bố thông báo / sắc lệnh' },
        { code: 'CP-PASSPORT', title: 'Thụ lý hồ sơ quốc gia', hint: 'Xử lý hộ chiếu / GP doanh nghiệp' },
        { code: 'CP-COORD', title: 'Điều phối liên ngành', hint: 'Luân chuyển / chỉ đạo hồ sơ' }
    ],
    'Y TẾ': [
        { code: 'YT-SOS', title: 'Ứng cứu SOS y tế', hint: 'Tiếp nhận cuộc gọi y tế khẩn cấp' },
        { code: 'YT-CERT', title: 'Cấp chứng nhận sức khỏe', hint: 'Cấp phôi y tế' },
        { code: 'YT-LOG', title: 'Nhật ký ca trực y', hint: 'Nộp báo cáo ca y tế' }
    ],
    'GIÁO DỤC': [
        { code: 'GD-DEGREE', title: 'Cấp văn bằng', hint: 'Cấp văn bằng / chứng chỉ' },
        { code: 'GD-APP', title: 'Thụ lý hồ sơ GD', hint: 'Xử lý hồ sơ giáo dục' },
        { code: 'GD-LOG', title: 'Báo cáo đào tạo', hint: 'Nộp nhật ký ca GD' }
    ],
    'TÀI CHÍNH': [
        { code: 'TC-TAX', title: 'Thụ lý tờ khai thuế', hint: 'Xử lý hồ sơ thuế' },
        { code: 'TC-FINE', title: 'Xử phạt thuế', hint: 'Lập biên bản thuế' },
        { code: 'TC-LIC', title: 'Cấp GP / HĐĐT', hint: 'Cấp phôi tài chính' }
    ],
    'UBND': [
        { code: 'UB-CIVIL', title: 'Thụ lý hộ tịch', hint: 'Xử lý khai sinh / kết hôn / tạm trú' },
        { code: 'UB-REG', title: 'Số hóa cư dân', hint: 'Đăng ký / cập nhật hồ sơ cư dân' },
        { code: 'UB-BUILD', title: 'Giấy phép xây dựng', hint: 'Thụ lý / cấp GPXD' }
    ],
    'NGÂN HÀNG': [
        { code: 'NH-ACC', title: 'Duyệt mở tài khoản', hint: 'Xử lý yêu cầu mở TK' },
        { code: 'NH-PAY', title: 'Kiểm bảng lương', hint: 'Rà soát batch lương' },
        { code: 'NH-LOG', title: 'Nhật ký ca NH', hint: 'Nộp báo cáo ca ngân hàng' }
    ]
};

app.post('/api/officer/missions/list', requireAuth(), safeRoute(async (req, res) => {
    const me = req.officer;
    const agency = (isCrossAgencyOfficer(me) && req.body.agency) ? req.body.agency : me.agency;
    const day = todayKey();
    let list = unitMissions.filter(m => m.agency === agency && normalizeDateKey(m.date) === day);
    // Tự seed nhiệm vụ ngày nếu trống (lãnh đạo / bất kỳ cán bộ ĐV mở bàn)
    if (!list.length && AGENCY_MISSION_TEMPLATES[agency]) {
        AGENCY_MISSION_TEMPLATES[agency].forEach(t => {
            unitMissions.unshift({
                id: `NV-${Date.now().toString().slice(-6)}${Math.floor(Math.random() * 90)}`,
                agency, code: t.code, title: t.title, hint: t.hint,
                status: 'MỞ', date: day, createdAt: new Date().toLocaleString('vi-VN'),
                claimedBy: null, claimedName: null, completedBy: null, completedAt: null
            });
        });
        list = unitMissions.filter(m => m.agency === agency && normalizeDateKey(m.date) === day);
    }
    const templates = AGENCY_MISSION_TEMPLATES[agency] || [];
    res.json({
        success: true, agency, date: day, missions: list.slice(0, 40), templates,
        mine: list.filter(m => m.claimedBy === me.username || m.completedBy === me.username)
    });
}));
app.post('/api/officer/missions/claim', requireAuth(), safeRoute(async (req, res) => {
    const me = req.officer;
    const m = unitMissions.find(x => x.id === req.body.id);
    if (!m) return res.status(404).json({ error: 'Không tìm thấy nhiệm vụ.' });
    if (!canAccessAgencyRecord(me, m.agency) && me.agency !== m.agency) {
        return res.status(403).json({ error: 'Nhiệm vụ ngoài đơn vị của bạn.' });
    }
    if (m.status === 'HOÀN THÀNH') return res.status(409).json({ error: 'Nhiệm vụ đã hoàn thành.' });
    if (m.claimedBy && m.claimedBy !== me.username) {
        return res.status(409).json({ error: `Đã được ${m.claimedName} nhận.` });
    }
    m.status = 'ĐANG LÀM';
    m.claimedBy = me.username;
    m.claimedName = me.displayName;
    m.claimedAt = new Date().toLocaleString('vi-VN');
    addLog(`${me.displayName} nhận nhiệm vụ [${m.code}] ${m.title} — ${m.agency}.`);
    broadcastUpdate();
    res.json({ success: true, mission: m });
}));
app.post('/api/officer/missions/complete', requireAuth(), safeRoute(async (req, res) => {
    const me = req.officer;
    const m = unitMissions.find(x => x.id === req.body.id);
    if (!m) return res.status(404).json({ error: 'Không tìm thấy nhiệm vụ.' });
    if (m.claimedBy && m.claimedBy !== me.username && !canManageUnitPayroll(me) && !isCrossAgencyOfficer(me)) {
        return res.status(403).json({ error: 'Chỉ người nhận nhiệm vụ hoặc lãnh đạo ĐV mới đánh dấu hoàn thành.' });
    }
    if (m.status === 'HOÀN THÀNH') return res.status(409).json({ error: 'Đã hoàn thành trước đó.' });
    m.status = 'HOÀN THÀNH';
    m.completedBy = me.username;
    m.completedName = me.displayName;
    m.completedAt = new Date().toLocaleString('vi-VN');
    if (!m.claimedBy) { m.claimedBy = me.username; m.claimedName = me.displayName; }
    bumpShiftStat(me.username, 'registrations', 1); // thưởng nhẹ vào KPI ca (NL)
    const note = (req.body.note || '').trim().slice(0, 200);
    if (note) m.note = note;
    addLog(`${me.displayName} hoàn thành nhiệm vụ [${m.code}] ${m.title} — ${m.agency}.`);
    broadcastUpdate();
    res.json({ success: true, mission: m, message: 'Đã ghi nhận hoàn thành nhiệm vụ ca (+KPI đăng ký).' });
}));
...
const SOS_CATEGORY_AGENCY = {
    ...
    'TỐ TỤNG KHẨN': 'TOÀ ÁN',
    'SỰ CỐ HỌC ĐƯỜNG': 'GIÁO DỤC',
    'GIAN LẬN THUẾ': 'TÀI CHÍNH',
    'SỰ CỐ ĐỊA PHƯƠNG': 'UBND',
    'THANH TRA KHẨN': 'THANH TRA',
    'KHÁC': 'CHÍNH PHỦ',
};
...
app.post('/api/dispatch/resolve', safeRoute(async (req, res) => {
    ...
    if (call.status === 'ĐÃ CỬ CÁN BỘ XỬ LÝ') {
        return res.status(409).json({ error: `Cuộc gọi đã được ${call.handledBy || 'cán bộ khác'} tiếp nhận.` });
    }
    const preferred = call.suggestedAgency;
    const canTake = isCrossAgencyOfficer(officer) || officer.agency === preferred || officer.agency === 'CHÍNH PHỦ';
    if (!canTake) {
        return res.status(403).json({
            error: `Cuộc gọi ưu tiên đơn vị [${preferred}]. Đơn vị của bạn là [${officer.agency}] — chỉ đơn vị được gợi ý, CHÍNH PHỦ, THANH TRA hoặc ADMIN mới tiếp nhận.`
        });
    }
    call.status = 'ĐÃ CỬ CÁN BỘ XỬ LÝ';
    call.handledBy = officer.displayName;
    call.handledAgency = officer.agency;
    call.handledAt = new Date().toLocaleString('vi-VN');
    bumpShiftStat(officer.username, 'appsProcessed', 1);
    addLog(`🚨 ${officer.displayName} [${officer.agency}] tiếp nhận SOS [${call.id}] (${call.category}) tại ${call.location}.`);
    broadcastUpdate();
